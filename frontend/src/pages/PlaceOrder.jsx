  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t' >
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <div className="flex gap-3">
          <input required onChange={onChangeHandler} name='zipcode' value={formData.zipcode} type="number" placeholder='Zipocde' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' />
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            <div onClick={() => setMethod('stripe')}  className="flex items-center gap-1 border p-2 px-3 cursor-pointer">
              ...
              <img src={assets.stripe_logo} className='h-5 mx-3' alt="" />
            </div>
            <div onClick={() => setMethod('razorpay')} className="flex items-center gap-1 border p-2 px-3 cursor-pointer">
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'razorpay' ? 'bg-green-400' : ''}`} ></p>
              <img src={assets.razorpay_logo} className='h-5 mx-3' alt="" />
            </div>
